...
import { Admins } from '@local/payload/collections/Admins'
...
import { AnnouncementBar } from '@local/payload/globals/AnnouncementBar'
...
const baseConfig: Config = {
  ...
  collections: [Pages, Articles, Admins, Media],
  db: mongooseAdapter({
    url: env.PAYLOAD_PRIVATE_DATABASE_URI,
  }),
  editor: lexicalEditor(),
  globals: [AnnouncementBar, NavigationMenu, Footer],
  plugins: [
